package com.skysean.travel.password.table;

import com.skysean.travel.password.table.enums.Align;
import com.skysean.travel.password.table.enums.NullPolicy;
import com.skysean.travel.password.table.table.Body;
import com.skysean.travel.password.table.table.Cell;
import com.skysean.travel.password.table.table.Header;
import com.skysean.travel.password.table.util.StringPadUtil;
...
/**
 * console table来源于github:https://github.com/clyoudu/clyoudu-util/tree/master/src/main/java/github/clyoudu/consoletable
...
public class ConsoleTable {
    ...
    public static class ConsoleTableBuilder {
        ...
        public ConsoleTableBuilder addRow(String ...values){
            List<Cell> row = new ArrayList<>();
            for(String value : values){
                row.add(Cell.of(value));
            }
            return addRow(row);
        }
        ...
        public ConsoleTableBuilder addHeaders(String ...headerArray){
            List<Cell> headers = new ArrayList<>();

            for(String header : headerArray){
                headers.add(Cell.of(header));
            }
